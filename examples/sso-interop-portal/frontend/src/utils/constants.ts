...
export const INTEROP_CENTER_ADDRESS: Address = "0x0000000000000000000000000000000000010010";
export const INTEROP_HANDLER_ADDRESS: Address = "0x000000000000000000000000000000000001000d";
